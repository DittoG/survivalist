...
public class Constants {
    ...
    public static int NUMBER_OF_INVENTORY_ITEMS = 35;
    ...
    public final static int MACHETE = 3;

    // TOOLS********************************************************************************
    public final static int AXE = 4;
    public final static int HAMMER = 5;
    public final static int FLINTANDSTONE = 6;
    public final static int GRAPPLINGHOOK = 7;

    // INGREDIENT***************************************************************************
    public final static int BRANCH = 8;
    ...
    //NPCS*********************************************************************************
    public static int NUMBER_OF_NPCS = 3;

    public final static int UNCLEDARWIN = 0;
    public final static int AVIATORBILL = 1;
    ...
    public final static int CABIN = 0;
